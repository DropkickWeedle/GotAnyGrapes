...
public class GameScreenForm : Form
{
    ...
    public GameScreenForm()
    {
        ...
        startButton = new Button
        {
            ...
            Width = 200,
            Height = 100,
            // Dynamically position in the center
            Top = (Screen.PrimaryScreen.Bounds.Height / 2) - 50,
            Left = (Screen.PrimaryScreen.Bounds.Width / 2) - 100
        };
    ...
    private void CreateObstacle()
    {
        ...
        if (lastObstacleRight < this.ClientSize.Width - 150)
        {
